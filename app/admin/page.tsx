...
export default function Admin() {
  ...
  // Determine access
  const isMainAdmin = userEmail === 'cameronshiu@gmail.com'

  if (!userEmail) {
    return <p className="text-center mt-20">Please sign in to access the admin panel.</p>
  }

  if (!isMainAdmin && !passwordVerified) {
    return (
      <div className="flex flex-col justify-center items-center h-screen">
        <p className="text-xl mb-4">Enter admin password to access this panel:</p>
        <input
          type="password"
